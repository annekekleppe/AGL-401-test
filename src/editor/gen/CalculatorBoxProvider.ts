...
/**
 * This class implements the box provider for a single node of type Calculator.
 ...
 */
export class CalculatorBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "Calculator";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._node as Calculator, "Calculator-overall", "", [
            BoxFactory.horizontalLayout(
                this._node as Calculator,
                "Calculator-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._node as Calculator, "Calculator", "top-1-line-0-item-0"),
                    BoxUtil.textBox(this._node as Calculator, "name"),
                ],
                { selectable: false },
            ),
            BoxUtil.verticalPartListBox(
                this._node as Calculator,
                (this._node as Calculator).inputFields,
                "inputFields",
                null,
                this.mainHandler,
            ),
            BoxUtil.emptyLineBox(this._node as Calculator, "Calculator-empty-line-2"),
            BoxUtil.verticalPartListBox(
                this._node as Calculator,
                (this._node as Calculator).outputFields,
                "outputFields",
                null,
                this.mainHandler,
            ),
