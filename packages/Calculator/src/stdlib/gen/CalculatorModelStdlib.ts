...
/**
 * Class CalculatorModelStdlib provides an entry point for all predefined elements in language CalculatorModel.
 ...
 */
export class CalculatorModelStdlib implements FreStdlib {
    ...
    public static getInstance(): FreStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new CalculatorModelStdlib();
        }
        return this.stdlib;
    }

    public elements: FreNamedNode[] = []; // the predefined elements of language CalculatorModel
