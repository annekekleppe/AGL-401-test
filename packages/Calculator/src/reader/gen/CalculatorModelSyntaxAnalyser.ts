...
import { CalculatorSyntaxAnalyserPart, CalculatorModelCommonSyntaxAnalyserPart } from "./index.js";
 ...
 *
 */
export class CalculatorModelSyntaxAnalyser extends SyntaxAnalyserByMethodRegistrationAbstract<CalculatorModel> {
    sourceName: string = "";
    ...
    registerHandlers() {
        super.registerFor("Calculator", (n, c, s) => this._unit_Calculator_analyser.transformCalculator(n, c, s));
        super.registerFor("InputField", (n, c, s) => this._unit_Calculator_analyser.transformInputField(n, c, s));
        super.registerFor("OutputField", (n, c, s) => this._unit_Calculator_analyser.transformOutputField(n, c, s));
        super.registerFor("InputFieldReference", (n, c, s) => this._unit_Calculator_analyser.transformInputFieldReference(n, c, s));
        super.registerFor("NumberLiteralExpression", (n, c, s) => this._unit_Calculator_analyser.transformNumberLiteralExpression(n, c, s));
        super.registerFor("CalcExpression", (n, c, s) => this._unit_Calculator_analyser.transformCalcExpression(n, c, s));
        super.registerFor("LiteralExpression", (n, c, s) => this._unit_Calculator_analyser.transformLiteralExpression(n, c, s));
        super.registerFor("__fre_binary_CalcExpression", (n, c, s) =>
            this._unit_Calculator_analyser.transform__fre_binary_CalcExpression(n, c, s),
        );
