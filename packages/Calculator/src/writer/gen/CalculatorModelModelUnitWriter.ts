...
export class CalculatorModelModelUnitWriter implements FreWriter {
    ...
    public writeNameOnly(modelelement: FreNode): string {
        ...
        } else if (modelelement instanceof InputField) {
            return modelelement.name;
        } else {
            // make sure the global variables are reset
            this.output = [];
    ...
    private unparse(modelelement: FreNode, short: boolean) {
        ...
        switch (modelelement.freLanguageConcept()) {
            case "InputField":
                this.unparseInputField(modelelement as InputField, short);
                break;
            case "OutputField":
                this.unparseOutputField(modelelement as OutputField, short);
                break;
            case "InputFieldReference":
                this.unparseInputFieldReference(modelelement as InputFieldReference, short);
                break;
            case "CalcExpression":
                this.unparseCalcExpression(modelelement as CalcExpression, short);
                break;
            ...
            case "DivideExpression":
                ...
                break;
            case "Calculator":
                this.unparseCalculator(modelelement as Calculator, short);
                break;
            case "INamedConcept":
     ...
     */
    private unparseCalculator(modelelement: Calculator, short: boolean) {
     ...
     */
    private unparseInputField(modelelement: InputField, short: boolean) {
     ...
     */
    private unparseOutputField(modelelement: OutputField, short: boolean) {
     ...
     */
    private unparseInputFieldReference(modelelement: InputFieldReference, short: boolean) {
        this._unparseReference(modelelement.field, short);
    }
     ...
     */
    private unparseCalcExpression(modelelement: CalcExpression, short: boolean) {
     ...
     */
    private unparseINamedConcept(modelelement: FreNode, short: boolean) {
