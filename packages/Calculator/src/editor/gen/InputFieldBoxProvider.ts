...
import { InputField } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type InputField.
 ...
 */
export class InputFieldBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "InputField";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as InputField,
            "InputField-hlist-line-0",
            "",
            [BoxUtil.labelBox(this._node as InputField, "input", "top-1-line-0-item-0"), BoxUtil.textBox(this._node as InputField, "name")],
            { selectable: false },
        );
    }
}
