...
/**
 * This class implements the box provider for a single node of type InputFieldReference.
 ...
 */
export class InputFieldReferenceBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "InputFieldReference";
    }
    ...
    private getDefault(): Box {
        return createDefaultExpressionBox(
            this._node as InputFieldReference,
            [
                BoxUtil.referenceBox(
                    this._node as InputFieldReference,
                    "field",
                    (selected: string) => {
                        (this._node as InputFieldReference).field = FreNodeReference.create<InputField>(selected, "InputField");
                    },
