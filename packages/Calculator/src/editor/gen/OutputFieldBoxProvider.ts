...
import { OutputField } from "../../language/gen/index.js";

/**
 * This class implements the box provider for a single node of type OutputField.
 ...
 */
export class OutputFieldBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "OutputField";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._node as OutputField,
            "OutputField-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._node as OutputField, "output", "top-1-line-0-item-0"),
                BoxUtil.getBoxOrAction(this._node as OutputField, "expression", "CalcExpression", this.mainHandler),
            ],
            { selectable: false },
        );
    }
