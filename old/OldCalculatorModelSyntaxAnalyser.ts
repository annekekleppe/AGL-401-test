...
import { CalculatorSyntaxAnalyserPart, CalculatorModelCommonSyntaxAnalyserPart } from "@freon4dsl/samples-calculator/dist/reader/gen";
import {Calculator} from "@freon4dsl/samples-calculator/dist/language/gen";
 ...
 *
 */
export class OldCalculatorModelSyntaxAnalyser implements AGL.SyntaxAnalyser<Calculator> {
    sourceName: string = "";
    locationMap: any;
